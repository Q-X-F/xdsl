...
def highlight_x86(code: str) -> str:
    ...
    for line in code.splitlines():
        ...
        for token in tokens:
            ...
            elif clean.isdigit() or (clean.startswith("0x") and all(c in "0123456789abcdefABCDEF" for c in clean[2:])) or (clean.startswith("-")and all(c in "0123456789" for c in clean[1:])):
